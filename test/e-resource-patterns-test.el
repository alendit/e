...
(ert-deftest e-resource-patterns-test-glob-facade-semantics ()
  ...
  (should (equal (e-resource-pattern-glob-fd-pattern "literal[abc].txt")
                 "literal\\[abc\\].txt"))
  (should (equal (e-resource-pattern-glob-max-depth "*") 1))
  (should (equal (e-resource-pattern-glob-max-depth "docs/*.org") 2))
  (should (null (e-resource-pattern-glob-max-depth "**/*.org")))
