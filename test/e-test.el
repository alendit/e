...
(ert-deftest e-test-exposes-core-harness-api ()
  ...
  (should (fboundp 'e-harness-enable-layer-id))
  (should (fboundp 'e-harness-disable-layer-id))
  (should (fboundp 'e-harness-layer-enabled-p))
  (should (fboundp 'e-harness-layer-effective-p))
  (should (fboundp 'e-harness-effective-layer-ids))
  (should (fboundp 'e-harness-activate-capability))
  (should (fboundp 'e-harness-prompt-batch))
  (should (fboundp 'e-harness-prompt-async))
  (should (fboundp 'e-harness-wait-batch))
  (should (fboundp 'e-harness-follow-up-batch))
  (should (fboundp 'e-backend-stream-batch))
  (should (fboundp 'e-loop-run-turn-batch))
  (should (fboundp 'e-tools-execute-batch))
  (should-not (fboundp 'e-harness-prompt))
  (should-not (fboundp 'e-harness-wait))
  (should-not (fboundp 'e-harness-follow-up))
  (should-not (fboundp 'e-harness-compact-session))
  (should-not (fboundp 'e-backend-stream))
  (should-not (fboundp 'e-loop-run-turn))
  (should-not (fboundp 'e-tools-execute))
